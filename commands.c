...
command_array* new_command_arr(int size, int current, char* std_out, char* std_in) {
...
void put_std_in(command_array* command_arr, char* std_in) {
    if (command_arr == NULL) {
        return;
    }
    command_arr->std_in = std_in;
